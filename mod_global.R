...
url = "http://github.com/Deitsch-John/JoroSpiderData/raw/main/appfiles.zip"
download.file(url, "appfiles.zip")
unzip("appfiles.zip")

UScounties = sf::read_sf("US_counties", dsn = ".")
USstates = sf::read_sf("s_22mr22", dsn = ".")
phys <- sf::read_sf("ga_eco_l3", dsn = ".")

JoroData <- readr::read_csv("http://raw.githubusercontent.com/Deitsch-John/JoroSpiderData/main/Joro_Obs.csv")%>%
